...
//--------------------------------------------
    ...
    public void agregarProducto( String pNombreProveedor ,String pNombreProducto, int pID, Double pCosto, Double pPrecio, int pCantidad )
    {
        ...
        Producto nuevo = new Producto(pNombreProducto, pID, pCosto, pPrecio, pCantidad);
    ...
    public boolean vender( int pID, int pCantidad)
    {
        ...
        for(Proveedor p : Proveedores)
        {
            ...
            if(producto != null)
            {
                ...
                Canasta.add( new Producto(producto.getNombre(), producto.getID(), producto.getCosto(), producto.getPrecio(), pCantidad) );
                exito = true;
                }
            }
        }
    ...
    {
        Factura nueva = new Factura( Fecha , pRecibido,NombreTienda, Facturas.size(), Canasta);
        Facturas.add( nueva );
