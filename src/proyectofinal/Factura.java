 ...
 * @author sljim
 */
public class Factura extends Identidad  
{
    ...
    */
    public Factura(Calendar fecha, Double Recibido, String pNombre, int pID, ArrayList<Producto> pCompra) 
    {
       super(pNombre, pID, 0.0 );
       Compra=pCompra;
       Fecha = fecha;
       ...
       Total = 0.0;
        ...
        {
            Contenido.add(p.getNombre() + "-" + p.getCantidad() + "-" + p.getPrecio());
            Total+=p.getPrecio();
        }
